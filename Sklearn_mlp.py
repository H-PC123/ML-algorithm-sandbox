...
#basically much just a wrapper class for sklearn's neural_network.MLPClassifier

class Sklearn_MLP:
    def __init__(self):
        self.mlp = neural_network.MLPClassifier(hidden_layer_sizes=(1568,))
        self.output_classes = [x for x in range(10)]
        
    def train(self, train_images, train_labels, iterations=1000):
        self.mlp.fit(train_images, train_labels)
    ...
    def test_n_report(self, testing_set, testing_labels):
        ...
        print("\n====================== TESTING =========================")
        predictions = list(self.mlp.predict(testing_set))
