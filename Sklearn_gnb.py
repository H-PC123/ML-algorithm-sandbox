...
#pretty much just a wrapper class for sklearn's gaussian naive bayes learner
...
class Sklearn_Naive_Bayes:
    ...
    def train(self, train_images, train_labels, iterations=1000):
        self.gnb.fit(train_images, train_labels)
    ...
    def test_n_report(self, testing_set, testing_labels):
        ...
        print("\n====================== TESTING =========================")
        predictions = list(self.gnb.predict(testing_set))
